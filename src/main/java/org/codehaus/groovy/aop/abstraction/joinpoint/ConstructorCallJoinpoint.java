...
public class ConstructorCallJoinpoint implements Joinpoint {
    ...
    public ConstructorCallJoinpoint(Class<?> sender, String methodName, Object target, Object[] args, Class<?>[] argClasses) {
        super();
        this.sender = sender;
    ...
    public ConstructorCallJoinpoint(Class<?> sender, String methodName, Object target, Object[] args) {
        super();
        this.sender = sender;
        this.methodName = methodName;
        this.target     = target;
    ...
    public ConstructorCallJoinpoint(Class<?> sender, String methodName, Object[] args) {
        super();
        this.sender = sender;
        this.methodName = methodName;
        this.target     = args[0];
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ConstructorCallJoinpoint other = (ConstructorCallJoinpoint) obj;
