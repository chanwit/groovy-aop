...
public class AdviceCacheL2 {
	...
	private HashMap<Key, HashSet<Advice>> adviceCache = new HashMap<Key, HashSet<Advice>>();
	private HashMap<Aspect, HashSet<Key>> idxAspect = new HashMap<Aspect, HashSet<Key>>();
	private HashMap<Joinpoint, HashSet<Key>> idxJoinpoint = new HashMap<Joinpoint, HashSet<Key>>();
